...
import { ArrowRight, Circle, MessageCircle, BookOpen, Target } from "lucide-react"
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              ...
              <h2 className="font-serif text-4xl md:text-5xl font-bold text-foreground mb-6">The Circle Method</h2>
              <p className="font-serif text-3xl italic text-primary mb-8">Explore → Struggle → Discuss → Refine</p>
            </div>
              ...
              <CardContent className="pt-6">
                <div className="space-y-4 text-lg leading-relaxed text-muted-foreground">
                  <p>
                    ...
                    <strong className="text-foreground">attempt beautiful problems before seeing any solution</strong>.
                  </p>
                  ...
                  <p className="font-semibold text-foreground pt-4">This is how mathematical maturity is built.</p>
                </div>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="font-serif text-4xl font-bold text-foreground">Concept Sessions</h2>
            </div>

            <Card className="mb-8">
              <CardContent className="pt-6">
                <h3 className="text-2xl font-semibold text-foreground mb-6">How Concept Sessions Work</h3>
                <div className="space-y-6">
                  {[
                    ...
                    {
                      step: "2. Explore",
                      description: "Students attempt to explain what they notice.",
                    },
                    {
                      step: "3. Connect",
                      description: "Mentors guide students toward the underlying structure.",
                    },
                    {
                      step: "4. Reinforce",
                      description: "A few carefully-curated examples solidify the idea.",
                    },
                    {
                      step: "5. Reflect",
            ...
            <Card className="bg-primary/5">
              <CardContent className="pt-6">
                <h3 className="text-xl font-semibold text-foreground mb-4">What students gain</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="font-serif text-4xl font-bold text-foreground">Problem-Solving Sessions</h2>
            </div>

            <Card className="mb-8">
              <CardContent className="pt-6">
                <h3 className="text-2xl font-semibold text-foreground mb-6">How Problem-Solving Sessions Work</h3>
                <div className="space-y-6">
                  {[
                    {
                      step: "1. Rich problems",
                      description: "Students work individually on 4–6 non-routine problems.",
                    },
                    {
                      step: "2. Minimal hints",
                      description: "Mentors intervene only through strategic questions.",
                    },
                    {
                      step: "3. Present & discuss",
                      description: "Students present. Peers challenge. Mentors refine.",
                    },
                    {
                      step: "4. Strategy map",
                      description: "Sessions end with patterns and strategies summarised.",
                    },
                  ].map((item, index) => (
                    <div key={index} className="flex gap-4">
                      <div className="flex-shrink-0">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-8">
              ...
              <h2 className="font-serif text-4xl font-bold text-foreground">Workshop Sessions</h2>
            </div>

            <Card className="mb-8">
              <CardContent className="pt-6">
                <h3 className="text-2xl font-semibold text-foreground mb-6">Workshop Flow</h3>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 bg-primary/5 rounded-lg">
                    <span className="font-semibold text-foreground">Concept idea</span>
